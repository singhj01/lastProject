...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_10_1 Sensor_ADC (
        .Vref(Net_497),
        .sdone(Net_498),
        .eoc(Net_255),
        .aclk(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("270b63be-2609-43dc-8f38-c7409402c47d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ae7d59c8-bab1-46b4-966b-b40b350a588f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e219d806-b36b-4a84-86ef-d2aaee1d5977"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e74a55a7-ff87-45fa-b2dd-c7497c913011"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
