...
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
...
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_10"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_10\Bus_Connect_v2_10.v"
`endif
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_10_0 Sensor_ADC (
        .Vref(Net_385),
        .sdone(Net_386),
        .eoc(Net_255),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Accel_Z_net;
	wire [0:0] tmpFB_0__Accel_Z_net;
	wire [0:0] tmpIO_0__Accel_Z_net;
	wire [0:0] tmpINTERRUPT_0__Accel_Z_net;
	electrical [0:0] tmpSIOVREF__Accel_Z_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("30a4585a-36f3-4ba3-93d8-da1595971452"),
		  ...
		  .input_buffer_sel(2'b00))
		Accel_Z
		 (.oe(tmpOE__Accel_Z_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accel_Z_net[0:0]}),
		  .analog({Net_86}),
		  .io({tmpIO_0__Accel_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Accel_Z_net),
		  .interrupt({tmpINTERRUPT_0__Accel_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accel_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Accel_Y_net;
	wire [0:0] tmpFB_0__Accel_Y_net;
	wire [0:0] tmpIO_0__Accel_Y_net;
	wire [0:0] tmpINTERRUPT_0__Accel_Y_net;
	electrical [0:0] tmpSIOVREF__Accel_Y_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("39a08259-2877-4246-8b41-602680950631"),
		  ...
		  .input_buffer_sel(2'b00))
		Accel_Y
		 (.oe(tmpOE__Accel_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accel_Y_net[0:0]}),
		  .analog({Net_64}),
		  .io({tmpIO_0__Accel_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Accel_Y_net),
		  .interrupt({tmpINTERRUPT_0__Accel_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accel_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Accel_X_net;
	wire [0:0] tmpFB_0__Accel_X_net;
	wire [0:0] tmpIO_0__Accel_X_net;
	wire [0:0] tmpINTERRUPT_0__Accel_X_net;
	electrical [0:0] tmpSIOVREF__Accel_X_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .input_buffer_sel(2'b00))
		Accel_X
		 (.oe(tmpOE__Accel_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accel_X_net[0:0]}),
		  .analog({Net_82}),
		  .io({tmpIO_0__Accel_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Accel_X_net),
		  .interrupt({tmpINTERRUPT_0__Accel_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accel_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
